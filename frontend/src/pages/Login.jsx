...
const s = {
  ...
  input: { width: '100%', padding: '10px 12px', border: '1px solid #cbd5e1', borderRadius: 8, fontSize: 14, marginBottom: 16, boxSizing: 'border-box', outline: 'none' },
...
export default function Login() {
  ...
  return (
    <div style={s.container}>
      <div style={s.card}>
        <div style={s.title}>TaskManager</div>
